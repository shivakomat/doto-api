error id: file://<WORKSPACE>/doto-api/app/controllers/AuthController.scala:
...
non-local guesses:
	 ...
	 -io/circe/syntax/RegisterRequest#
	 -play/api/mvc/RegisterRequest#
	 -JsonHelper.RegisterRequest#
	 -RegisterRequest#
	 -scala/Predef.RegisterRequest#
offset: 775
...
class AuthController @Inject()(
  ...
  def register: Action[AnyContent] = Action.async { request =>
    ...
    decode[Reg@@isterRequest](body) match
