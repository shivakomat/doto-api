error id: file://<WORKSPACE>/doto-api/app/repositories/ProfileRepository.scala:HasDatabaseConfigProvider.
file://<WORKSPACE>/doto-api/app/repositories/ProfileRepository.scala
empty definition using pc, found symbol in pc: 
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -tables/HasDatabaseConfigProvider.
	 -tables/HasDatabaseConfigProvider#
	 -tables/HasDatabaseConfigProvider().
	 -AppPostgresProfile.api.HasDatabaseConfigProvider.
	 -AppPostgresProfile.api.HasDatabaseConfigProvider#
	 -AppPostgresProfile.api.HasDatabaseConfigProvider().
	 ...
	 -HasDatabaseConfigProvider#
	 -HasDatabaseConfigProvider().
	 -scala/Predef.HasDatabaseConfigProvider.
	 -scala/Predef.HasDatabaseConfigProvider#
	 -scala/Predef.HasDatabaseConfigProvider().
offset: 167
