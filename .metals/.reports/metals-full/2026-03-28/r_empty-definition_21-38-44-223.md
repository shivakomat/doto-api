error id: file://<WORKSPACE>/doto-api/app/controllers/AuthController.scala:Action#
file://<WORKSPACE>/doto-api/app/controllers/AuthController.scala
empty definition using pc, found symbol in pc: 
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -io/circe/syntax/Action#
	 -play/api/mvc/Action#
	 -JsonHelper.Action#
	 -Action#
	 -scala/Predef.Action#
...
class AuthController @Inject()(
  ...
  def register: Acti@@on[AnyContent] = Action.async { request =>
