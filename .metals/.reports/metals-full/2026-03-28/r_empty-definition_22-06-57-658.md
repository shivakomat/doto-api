error id: file://<WORKSPACE>/doto-api/test/controllers/RewardControllerSpec.scala:
file://<WORKSPACE>/doto-api/test/controllers/RewardControllerSpec.scala
empty definition using pc, found symbol in pc: 
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -play/api/test/Helpers.Json#
	 -Json#
	 -scala/Predef.Json#
offset: 2566
uri: file://<WORKSPACE>/doto-api/test/controllers/RewardControllerSpec.scala
text:
```scala
package controllers
