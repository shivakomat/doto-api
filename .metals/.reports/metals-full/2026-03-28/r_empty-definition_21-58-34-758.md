error id: file://<WORKSPACE>/doto-api/app/repositories/ProfileRepository.scala:Profile#
...
non-local guesses:
	 -models/Profile#
	 -tables/Profile#
	 -AppPostgresProfile.api.Profile#
	 -Profile#
	 -scala/Predef.Profile#
offset: 896
...
class ProfileRepository @Inject()(
  ...
  def create(profile: Pro@@file): Future[Profile] =
