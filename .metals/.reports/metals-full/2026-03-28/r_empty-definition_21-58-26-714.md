error id: file://<WORKSPACE>/doto-api/app/repositories/ProfileRepository.scala:ExecutionContext#
file://<WORKSPACE>/doto-api/app/repositories/ProfileRepository.scala
empty definition using pc, found symbol in pc: 
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -tables/ExecutionContext#
	 -AppPostgresProfile.api.ExecutionContext#
...
)(implicit ec: ExecutionCont@@ext) extends HasDatabaseConfigProvider[AppPostgresProfile]:
