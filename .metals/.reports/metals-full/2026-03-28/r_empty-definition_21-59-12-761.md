error id: file://<WORKSPACE>/doto-api/app/repositories/ProfileRepository.scala:DatabaseConfigProvider#
file://<WORKSPACE>/doto-api/app/repositories/ProfileRepository.scala
empty definition using pc, found symbol in pc: 
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -tables/DatabaseConfigProvider#
	 -AppPostgresProfile.api.DatabaseConfigProvider#
	 -play/api/db/slick/DatabaseConfigProvider#
	 -DatabaseConfigProvider#
	 -scala/Predef.DatabaseConfigProvider#
offset: 398
...
class ProfileRepository @Inject()(
  protected val dbConfigProvider: DatabaseC@@onfigProvider
