error id: file://<WORKSPACE>/doto-api/app/controllers/AuthController.scala:AbstractController#
file://<WORKSPACE>/doto-api/app/controllers/AuthController.scala
empty definition using pc, found symbol in pc: 
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -io/circe/syntax/AbstractController#
	 -play/api/mvc/AbstractController#
	 -AbstractController#
	 -scala/Predef.AbstractController#
offset: 622
...
class AuthController @Inject()(
  ...
  jwtUtils:    JwtUtils
)(implicit ec: ExecutionContext) extends Abstr@@actController(cc):
