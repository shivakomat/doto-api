error id: file://<WORKSPACE>/doto-api/app/repositories/ProfileRepository.scala:UUID#
...
class ProfileRepository @Inject()(
  ...
  def listByFamily(familyId: UU@@ID): Future[Seq[Profile]] =
