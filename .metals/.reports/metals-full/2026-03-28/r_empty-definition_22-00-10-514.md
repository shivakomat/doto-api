error id: file://<WORKSPACE>/doto-api/app/repositories/ProfileRepository.scala:String#
...
class ProfileRepository @Inject()(
  ...
  def findByUsername(username: St@@ring): Future[Option[Profile]] =
