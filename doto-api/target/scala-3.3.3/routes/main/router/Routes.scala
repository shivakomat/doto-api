...
class Routes(
  ...
  def documentation = List(
    ...
    ("""POST""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """api/auth/claim-profile""", """controllers.AuthController.claimProfile"""),
    ...
    ("""GET""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """api/members/""" + "$" + """id<[^/]+>/claim-status""", """controllers.MemberController.claimStatus(id:String)"""),
  ...
  // @LINE:7
  private lazy val controllers_AuthController_claimProfile3_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("api/auth/claim-profile")))
  )
  private lazy val controllers_AuthController_claimProfile3_invoker = createInvoker(
    AuthController_4.claimProfile,
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "router",
      "controllers.AuthController",
      "claimProfile",
      Nil,
      "POST",
      this.prefix + """api/auth/claim-profile""",
      """""",
      Seq()
    )
  )
  ...
  // @LINE:8
  private lazy val controllers_AuthController_me4_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("api/auth/me")))
  )
  private lazy val controllers_AuthController_me4_invoker = createInvoker(
    AuthController_4.me,
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "router",
      "controllers.AuthController",
  ...
  // @LINE:9
  private lazy val controllers_AuthController_updateProfile5_route = Route("PATCH",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("api/auth/profile")))
  )
  private lazy val controllers_AuthController_updateProfile5_invoker = createInvoker(
  ...
  // @LINE:10
  private lazy val controllers_AuthController_changePassword6_route = Route("PATCH",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("api/auth/change-password")))
  )
  private lazy val controllers_AuthController_changePassword6_invoker = createInvoker(
  ...
  // @LINE:13
  private lazy val controllers_FamilyController_preview7_route = Route("GET",
  ...
  private lazy val controllers_FamilyController_preview7_invoker = createInvoker(
  ...
  // @LINE:14
  private lazy val controllers_FamilyController_create8_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("api/families")))
  )
  private lazy val controllers_FamilyController_create8_invoker = createInvoker(
  ...
  // @LINE:15
  private lazy val controllers_FamilyController_join9_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("api/families/join")))
  )
  private lazy val controllers_FamilyController_join9_invoker = createInvoker(
  ...
  // @LINE:16
  private lazy val controllers_FamilyController_mine10_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("api/families/mine")))
  )
  private lazy val controllers_FamilyController_mine10_invoker = createInvoker(
  ...
  // @LINE:17
  private lazy val controllers_FamilyController_updateName11_route = Route("PATCH",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("api/families/mine")))
  )
  private lazy val controllers_FamilyController_updateName11_invoker = createInvoker(
  ...
  // @LINE:18
  private lazy val controllers_FamilyController_inviteCode12_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("api/families/mine/invite-code")))
  )
  private lazy val controllers_FamilyController_inviteCode12_invoker = createInvoker(
  ...
  // @LINE:21
  private lazy val controllers_MemberController_list13_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("api/members")))
  )
  private lazy val controllers_MemberController_list13_invoker = createInvoker(
  ...
  // @LINE:22
  private lazy val controllers_MemberController_create14_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("api/members")))
  )
  private lazy val controllers_MemberController_create14_invoker = createInvoker(
  ...
  // @LINE:23
  private lazy val controllers_MemberController_claimStatus15_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("api/members/"), DynamicPart("id", """[^/]+""", encodeable=true), StaticPart("/claim-status")))
  )
  private lazy val controllers_MemberController_claimStatus15_invoker = createInvoker(
    MemberController_2.claimStatus(fakeValue[String]),
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "router",
      "controllers.MemberController",
      "claimStatus",
      Seq(classOf[String]),
      "GET",
      this.prefix + """api/members/""" + "$" + """id<[^/]+>/claim-status""",
      """""",
      Seq()
    )
  )
  ...
  // @LINE:24
  private lazy val controllers_MemberController_update16_route = Route("PUT",
  ...
  private lazy val controllers_MemberController_update16_invoker = createInvoker(
  ...
  // @LINE:25
  private lazy val controllers_MemberController_delete17_route = Route("DELETE",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("api/members/"), DynamicPart("id", """[^/]+""", encodeable=true)))
  )
  private lazy val controllers_MemberController_delete17_invoker = createInvoker(
  ...
  // @LINE:28
  private lazy val controllers_EventController_list18_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("api/events")))
  )
  private lazy val controllers_EventController_list18_invoker = createInvoker(
  ...
  // @LINE:29
  private lazy val controllers_EventController_create19_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("api/events")))
  )
  private lazy val controllers_EventController_create19_invoker = createInvoker(
  ...
  // @LINE:30
  private lazy val controllers_EventController_get20_route = Route("GET",
  ...
  private lazy val controllers_EventController_get20_invoker = createInvoker(
  ...
  // @LINE:31
  private lazy val controllers_EventController_update21_route = Route("PUT",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("api/events/"), DynamicPart("id", """[^/]+""", encodeable=true)))
  )
  private lazy val controllers_EventController_update21_invoker = createInvoker(
  ...
  // @LINE:32
  private lazy val controllers_EventController_delete22_route = Route("DELETE",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("api/events/"), DynamicPart("id", """[^/]+""", encodeable=true)))
  )
  private lazy val controllers_EventController_delete22_invoker = createInvoker(
  ...
  // @LINE:35
  private lazy val controllers_TaskController_list23_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("api/tasks")))
  )
  private lazy val controllers_TaskController_list23_invoker = createInvoker(
  ...
  // @LINE:36
  private lazy val controllers_TaskController_create24_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("api/tasks")))
  )
  private lazy val controllers_TaskController_create24_invoker = createInvoker(
  ...
  // @LINE:37
  private lazy val controllers_TaskController_get25_route = Route("GET",
  ...
  private lazy val controllers_TaskController_get25_invoker = createInvoker(
  ...
  // @LINE:38
  private lazy val controllers_TaskController_update26_route = Route("PUT",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("api/tasks/"), DynamicPart("id", """[^/]+""", encodeable=true)))
  )
  private lazy val controllers_TaskController_update26_invoker = createInvoker(
  ...
  // @LINE:39
  private lazy val controllers_TaskController_complete27_route = Route("PATCH",
  ...
  private lazy val controllers_TaskController_complete27_invoker = createInvoker(
  ...
  // @LINE:40
  private lazy val controllers_TaskController_delete28_route = Route("DELETE",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("api/tasks/"), DynamicPart("id", """[^/]+""", encodeable=true)))
  )
  private lazy val controllers_TaskController_delete28_invoker = createInvoker(
  ...
  // @LINE:43
  private lazy val controllers_ShoppingController_listLists29_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("api/shopping/lists")))
  )
  private lazy val controllers_ShoppingController_listLists29_invoker = createInvoker(
  ...
  // @LINE:44
  private lazy val controllers_ShoppingController_createList30_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("api/shopping/lists")))
  )
  private lazy val controllers_ShoppingController_createList30_invoker = createInvoker(
  ...
  // @LINE:45
  private lazy val controllers_ShoppingController_deleteList31_route = Route("DELETE",
  ...
  private lazy val controllers_ShoppingController_deleteList31_invoker = createInvoker(
  ...
  // @LINE:46
  private lazy val controllers_ShoppingController_listItems32_route = Route("GET",
  ...
  private lazy val controllers_ShoppingController_listItems32_invoker = createInvoker(
  ...
  // @LINE:47
  private lazy val controllers_ShoppingController_addItem33_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("api/shopping/lists/"), DynamicPart("id", """[^/]+""", encodeable=true), StaticPart("/items")))
  )
  private lazy val controllers_ShoppingController_addItem33_invoker = createInvoker(
  ...
  // @LINE:48
  private lazy val controllers_ShoppingController_clearChecked34_route = Route("DELETE",
  ...
  private lazy val controllers_ShoppingController_clearChecked34_invoker = createInvoker(
  ...
  // @LINE:49
  private lazy val controllers_ShoppingController_checkItem35_route = Route("PATCH",
  ...
  private lazy val controllers_ShoppingController_checkItem35_invoker = createInvoker(
  ...
  // @LINE:50
  private lazy val controllers_ShoppingController_deleteItem36_route = Route("DELETE",
  ...
  private lazy val controllers_ShoppingController_deleteItem36_invoker = createInvoker(
  ...
  // @LINE:53
  private lazy val controllers_RewardController_list37_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("api/rewards")))
  )
  private lazy val controllers_RewardController_list37_invoker = createInvoker(
  ...
  // @LINE:54
  private lazy val controllers_RewardController_create38_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("api/rewards")))
  )
  private lazy val controllers_RewardController_create38_invoker = createInvoker(
  ...
  // @LINE:55
  private lazy val controllers_RewardController_request39_route = Route("PATCH",
  ...
  private lazy val controllers_RewardController_request39_invoker = createInvoker(
  ...
  // @LINE:56
  private lazy val controllers_RewardController_approve40_route = Route("PATCH",
  ...
  private lazy val controllers_RewardController_approve40_invoker = createInvoker(
  ...
  // @LINE:57
  private lazy val controllers_RewardController_redeem41_route = Route("PATCH",
  ...
  private lazy val controllers_RewardController_redeem41_invoker = createInvoker(
  ...
  // @LINE:58
  private lazy val controllers_RewardController_delete42_route = Route("DELETE",
  ...
  private lazy val controllers_RewardController_delete42_invoker = createInvoker(
  ...
  // @LINE:61
  private lazy val controllers_DashboardController_get43_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("api/dashboard")))
  )
  private lazy val controllers_DashboardController_get43_invoker = createInvoker(
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    // @LINE:7
    case controllers_AuthController_claimProfile3_route(params@_) =>
      call { 
        controllers_AuthController_claimProfile3_invoker.call(AuthController_4.claimProfile)
      }
  
    // @LINE:8
    case controllers_AuthController_me4_route(params@_) =>
      call { 
        controllers_AuthController_me4_invoker.call(AuthController_4.me)
      }
  
    // @LINE:9
    case controllers_AuthController_updateProfile5_route(params@_) =>
      call { 
        controllers_AuthController_updateProfile5_invoker.call(AuthController_4.updateProfile)
      }
  
    // @LINE:10
    case controllers_AuthController_changePassword6_route(params@_) =>
      call { 
        controllers_AuthController_changePassword6_invoker.call(AuthController_4.changePassword)
      }
  
    // @LINE:13
    case controllers_FamilyController_preview7_route(params@_) =>
      call(params.fromPath[String]("code", None)) { (code) =>
        controllers_FamilyController_preview7_invoker.call(FamilyController_1.preview(code))
      }
  
    // @LINE:14
    case controllers_FamilyController_create8_route(params@_) =>
      call { 
        controllers_FamilyController_create8_invoker.call(FamilyController_1.create)
      }
  
    // @LINE:15
    case controllers_FamilyController_join9_route(params@_) =>
      call { 
        controllers_FamilyController_join9_invoker.call(FamilyController_1.join)
      }
  
    // @LINE:16
    case controllers_FamilyController_mine10_route(params@_) =>
      call { 
        controllers_FamilyController_mine10_invoker.call(FamilyController_1.mine)
      }
  
    // @LINE:17
    case controllers_FamilyController_updateName11_route(params@_) =>
      call { 
        controllers_FamilyController_updateName11_invoker.call(FamilyController_1.updateName)
      }
  
    // @LINE:18
    case controllers_FamilyController_inviteCode12_route(params@_) =>
      call { 
        controllers_FamilyController_inviteCode12_invoker.call(FamilyController_1.inviteCode)
      }
  
    // @LINE:21
    case controllers_MemberController_list13_route(params@_) =>
      call { 
        controllers_MemberController_list13_invoker.call(MemberController_2.list)
      }
  
    // @LINE:22
    case controllers_MemberController_create14_route(params@_) =>
      call { 
        controllers_MemberController_create14_invoker.call(MemberController_2.create)
      }
  
    // @LINE:23
    case controllers_MemberController_claimStatus15_route(params@_) =>
      call(params.fromPath[String]("id", None)) { (id) =>
        controllers_MemberController_claimStatus15_invoker.call(MemberController_2.claimStatus(id))
      }
  
    // @LINE:24
    case controllers_MemberController_update16_route(params@_) =>
      call(params.fromPath[String]("id", None)) { (id) =>
        controllers_MemberController_update16_invoker.call(MemberController_2.update(id))
      }
  
    // @LINE:25
    case controllers_MemberController_delete17_route(params@_) =>
      call(params.fromPath[String]("id", None)) { (id) =>
        controllers_MemberController_delete17_invoker.call(MemberController_2.delete(id))
      }
  
    // @LINE:28
    case controllers_EventController_list18_route(params@_) =>
      call(params.fromQuery[Option[String]]("from", Some(None)), params.fromQuery[Option[String]]("to", Some(None)), params.fromQuery[Option[String]]("memberId", Some(None))) { (from, to, memberId) =>
        controllers_EventController_list18_invoker.call(EventController_3.list(from, to, memberId))
      }
  
    // @LINE:29
    case controllers_EventController_create19_route(params@_) =>
      call { 
        controllers_EventController_create19_invoker.call(EventController_3.create)
      }
  
    // @LINE:30
    case controllers_EventController_get20_route(params@_) =>
      call(params.fromPath[String]("id", None)) { (id) =>
        controllers_EventController_get20_invoker.call(EventController_3.get(id))
      }
  
    // @LINE:31
    case controllers_EventController_update21_route(params@_) =>
      call(params.fromPath[String]("id", None)) { (id) =>
        controllers_EventController_update21_invoker.call(EventController_3.update(id))
      }
  
    // @LINE:32
    case controllers_EventController_delete22_route(params@_) =>
      call(params.fromPath[String]("id", None)) { (id) =>
        controllers_EventController_delete22_invoker.call(EventController_3.delete(id))
      }
  
    // @LINE:35
    case controllers_TaskController_list23_route(params@_) =>
      call(params.fromQuery[Option[String]]("assignedTo", Some(None)), params.fromQuery[Option[String]]("status", Some(None)), params.fromQuery[Option[String]]("priority", Some(None))) { (assignedTo, status, priority) =>
        controllers_TaskController_list23_invoker.call(TaskController_8.list(assignedTo, status, priority))
      }
  
    // @LINE:36
    case controllers_TaskController_create24_route(params@_) =>
      call { 
        controllers_TaskController_create24_invoker.call(TaskController_8.create)
      }
  
    // @LINE:37
    case controllers_TaskController_get25_route(params@_) =>
      call(params.fromPath[String]("id", None)) { (id) =>
        controllers_TaskController_get25_invoker.call(TaskController_8.get(id))
      }
  
    // @LINE:38
    case controllers_TaskController_update26_route(params@_) =>
      call(params.fromPath[String]("id", None)) { (id) =>
        controllers_TaskController_update26_invoker.call(TaskController_8.update(id))
      }
  
    // @LINE:39
    case controllers_TaskController_complete27_route(params@_) =>
      call(params.fromPath[String]("id", None)) { (id) =>
        controllers_TaskController_complete27_invoker.call(TaskController_8.complete(id))
      }
  
    // @LINE:40
    case controllers_TaskController_delete28_route(params@_) =>
      call(params.fromPath[String]("id", None)) { (id) =>
        controllers_TaskController_delete28_invoker.call(TaskController_8.delete(id))
      }
  
    // @LINE:43
    case controllers_ShoppingController_listLists29_route(params@_) =>
      call { 
        controllers_ShoppingController_listLists29_invoker.call(ShoppingController_5.listLists)
      }
  
    // @LINE:44
    case controllers_ShoppingController_createList30_route(params@_) =>
      call { 
        controllers_ShoppingController_createList30_invoker.call(ShoppingController_5.createList)
      }
  
    // @LINE:45
    case controllers_ShoppingController_deleteList31_route(params@_) =>
      call(params.fromPath[String]("id", None)) { (id) =>
        controllers_ShoppingController_deleteList31_invoker.call(ShoppingController_5.deleteList(id))
      }
  
    // @LINE:46
    case controllers_ShoppingController_listItems32_route(params@_) =>
      call(params.fromPath[String]("id", None)) { (id) =>
        controllers_ShoppingController_listItems32_invoker.call(ShoppingController_5.listItems(id))
      }
  
    // @LINE:47
    case controllers_ShoppingController_addItem33_route(params@_) =>
      call(params.fromPath[String]("id", None)) { (id) =>
        controllers_ShoppingController_addItem33_invoker.call(ShoppingController_5.addItem(id))
      }
  
    // @LINE:48
    case controllers_ShoppingController_clearChecked34_route(params@_) =>
      call(params.fromPath[String]("id", None)) { (id) =>
        controllers_ShoppingController_clearChecked34_invoker.call(ShoppingController_5.clearChecked(id))
      }
  
    // @LINE:49
    case controllers_ShoppingController_checkItem35_route(params@_) =>
      call(params.fromPath[String]("listId", None), params.fromPath[String]("itemId", None)) { (listId, itemId) =>
        controllers_ShoppingController_checkItem35_invoker.call(ShoppingController_5.checkItem(listId, itemId))
      }
  
    // @LINE:50
    case controllers_ShoppingController_deleteItem36_route(params@_) =>
      call(params.fromPath[String]("listId", None), params.fromPath[String]("itemId", None)) { (listId, itemId) =>
        controllers_ShoppingController_deleteItem36_invoker.call(ShoppingController_5.deleteItem(listId, itemId))
      }
  
    // @LINE:53
    case controllers_RewardController_list37_route(params@_) =>
      call(params.fromQuery[Option[String]]("memberId", Some(None)), params.fromQuery[Option[String]]("status", Some(None))) { (memberId, status) =>
        controllers_RewardController_list37_invoker.call(RewardController_7.list(memberId, status))
      }
  
    // @LINE:54
    case controllers_RewardController_create38_route(params@_) =>
      call { 
        controllers_RewardController_create38_invoker.call(RewardController_7.create)
      }
  
    // @LINE:55
    case controllers_RewardController_request39_route(params@_) =>
      call(params.fromPath[String]("id", None)) { (id) =>
        controllers_RewardController_request39_invoker.call(RewardController_7.request(id))
      }
  
    // @LINE:56
    case controllers_RewardController_approve40_route(params@_) =>
      call(params.fromPath[String]("id", None)) { (id) =>
        controllers_RewardController_approve40_invoker.call(RewardController_7.approve(id))
      }
  
    // @LINE:57
    case controllers_RewardController_redeem41_route(params@_) =>
      call(params.fromPath[String]("id", None)) { (id) =>
        controllers_RewardController_redeem41_invoker.call(RewardController_7.redeem(id))
      }
  
    // @LINE:58
    case controllers_RewardController_delete42_route(params@_) =>
      call(params.fromPath[String]("id", None)) { (id) =>
        controllers_RewardController_delete42_invoker.call(RewardController_7.delete(id))
      }
  
    // @LINE:61
    case controllers_DashboardController_get43_route(params@_) =>
      call { 
        controllers_DashboardController_get43_invoker.call(DashboardController_0.get)
      }
  }
}
